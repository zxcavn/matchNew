...
import { type ProposalMessageType, CosmosMessageType } from '@/shared/types';
...
const CreateProposalWidget = () => {
  ...
  const onChangeProposalForm = (values: CreateProposalFormValues & { type: ProposalMessageType }) => {
