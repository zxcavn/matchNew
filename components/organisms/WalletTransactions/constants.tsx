...
export const TABLE_COLUMNS: TableColumns<FormattedTx> = [
  {
    id: 'txHash',
    label: {
      text: 'SUMMARY.HASH',
        ...
        return (
          <Asset
            ...
            text={
              <FormattedPlural
                value={toAddress.length}
                one={<FormattedMessage id={'SUMMARY.ADDRESS'} />}
                few={<FormattedMessage id={'SUMMARY.ADDRESSES_1'} />}
                other={<FormattedMessage id={'SUMMARY.ADDRESSES_2'} />}
              />
            }
          />
        );
        ...
        return (
          <Asset
            ...
            text={
              <FormattedPlural
                value={amount}
                one={<FormattedMessage id={'SUMMARY.ASSET'} />}
                few={<FormattedMessage id={'SUMMARY.ASSETS_1'} />}
                other={<FormattedMessage id={'SUMMARY.ASSETS_2'} />}
              />
            }
          />
        );
