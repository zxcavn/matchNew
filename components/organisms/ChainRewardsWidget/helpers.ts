...
const RECIPIENT_TYPE_TITLE = {
  ...
  [ChainRewardRecipientType.XFT]: 'CHAIN_REWARDS.XFT.TITLE',
} as const;
...
const RECIPIENT_TYPE_DESCRIPTION = {
  ...
  [ChainRewardRecipientType.XFT]: 'CHAIN_REWARDS.XFT.DESCRIPTION',
} as const;

export const mapChainRewardsToCardData = (
  rewards: ChainRewardResponse[]
): (ChainRewardCardData & { id: string; recipientType: ChainRewardRecipientType })[] => {
