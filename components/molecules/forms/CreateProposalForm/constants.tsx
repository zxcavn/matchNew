...
import { ProposalMessageType, ViewOnlyProposalMessageType } from '@/shared/types';
...
export const getFormValidationRules = (
  proposalType: Exclude<ProposalMessageType, ViewOnlyProposalMessageType>,
...
export const getProposalInputs = ({
  ...
  [key in Exclude<
    ProposalMessageType,
    ProposalMessageType.TEXT | ViewOnlyProposalMessageType
  >]: FormBlockInputsData<CreateProposalFormValues>;
} => ({
