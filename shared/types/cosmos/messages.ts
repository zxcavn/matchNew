...
export enum ProposalMessageType {
  ...
  MSG_SOFTWARE_UPGRADE = '/cosmos.upgrade.v1beta1.MsgSoftwareUpgrade',
...
export type ViewOnlyProposalMessageType =
  | ProposalMessageType.MSG_SOFTWARE_UPGRADE
  | ProposalMessageType.PARAMETER_CHANGE;
