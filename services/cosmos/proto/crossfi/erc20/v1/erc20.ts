...
function createBaseTokenPair(): TokenPair {
  return { erc20Address: '', denom: '', enabled: false, contractOwner: 0, erc20Cheque: '' };
}
...
export const TokenPair = {
  encode(message: TokenPair, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.erc20Cheque !== '') {
      writer.uint32(42).string(message.erc20Cheque);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.erc20Cheque = reader.string();
          break;
        default:
  ...
  fromJSON(object: any): TokenPair {
    return {
      ...
      erc20Cheque: isSet(object.erc20Cheque) ? String(object.erc20Cheque) : '',
    };
  },
  ...
  toJSON(message: TokenPair): unknown {
    ...
    message.erc20Cheque !== undefined && (obj.erc20Cheque = message.erc20Cheque);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TokenPair>, I>>(object: I): TokenPair {
    ...
    message.erc20Cheque = object.erc20Cheque ?? '';
    return message;
  },
};

function createBaseRegisterCoinProposal(): RegisterCoinProposal {
  return { title: '', description: '', metadata: [], enableCheque: false };
}
...
export const RegisterCoinProposal = {
  encode(message: RegisterCoinProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.enableCheque === true) {
      writer.uint32(32).bool(message.enableCheque);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.enableCheque = reader.bool();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): RegisterCoinProposal {
    return {
      ...
      enableCheque: isSet(object.enableCheque) ? Boolean(object.enableCheque) : false,
    };
  },
  ...
  toJSON(message: RegisterCoinProposal): unknown {
    ...
    message.enableCheque !== undefined && (obj.enableCheque = message.enableCheque);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RegisterCoinProposal>, I>>(object: I): RegisterCoinProposal {
    ...
    message.enableCheque = object.enableCheque ?? false;
    return message;
  },
};
